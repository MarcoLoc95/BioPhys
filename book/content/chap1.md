...
Maybe you start to understand why the saying "correlation does not imply causation" is so popular among scientists. To establish causality, correlation is only one of the ingredients. What is also necessary is a sequence in time (effects must follow the cause and not the other way around), a plausible physical mechanism and the exclusion of possibile common causes. In this case, what is missing is the plausible mechanism behind this correlation: no physical theory could ever predict the relation

$$
\text{Babies named "Theodore"} = k \cdot \text{Fossil fuel use in Burundi}, \qquad \text{where } k \text{ is a constant}
$$

Not only, but if we were to forbid by law naming children "Theodore", we would see the correlation deteriorate immediately.

This is the main reason theoretical (bio)physics is just as important as experimental (bio)physics. Without a solid, sound, predictive model, experiments are only collections of data points. This came to be a recipe of success for physics: experimentalists try to find loopholes and counterexemples to break the models theoreticians make, and theoreticians try to extend the models to explain and predict the experimental outcomes. This apparent "fight" is only beneficial to scientific progress and has resulted in very solid theories and very advanced experimental setups. 

### A philosophical note and a suggestion for the future biophysicist
The approach to physics described above is known as **determinism**. Thanks to determinism and its accurate predictions, we could develop technology and control Nature to a level that was unthinkable to the early hominids on Earth. But one problem arises with it. In a utopic, deterministic world where we know everything about the state of the Universe at a certain time, every position and velocity of every particle, every charge, every force acting between every particle, then we can predict how the Universe will be in a minute, a year, a million years from now. Everything, including me writing this digital book and you reading it.
...
At this point, I hope you did not get a headache from this philosophical diversion. You can of course build your own beliefs about the nature of science, you can change your mind multiple times throughout your career and even allow yourself not to worry about it. But if you feel lost and seek my personal advice, let me reassure you that as a biologist or biophysicist you will encounter little to no quantum effects. What we know about biological systems so far is that they largely obey deterministic laws. Unpredictability arises from the **complexity** of the systems considered, were absolute knowledge is unattainable. This complexity can explain both reproducible trends in biology and variability in the individual outcomes. Your task as a biophysicist would probably involve modeling this complexity into simpler concepts, or explore it via experimental means. All this, while trying not to think about free will too much.

### Why biological physics?

Shamefully, many physicists still disregard biophysics as a "real" branch of physics. Most argumentations revolve around the idea that biological problems are ill-defined and lack a proper reductionist theoretical framework. What is life, mathematically? What equation tells us whether viruses are alive or not? There is no $F=m\cdot a$ in biology, or in other words a theoretical framework that would quantitatively predict cell division, migration, protein expression and evolution. One could argue that quantum mechanics does not predict the macroscopic motion of the planets, the turbulent flow of fluids or the functioning of a computer either; however, such a discussion would prove unfruitful for the progress of biophysics, and I discourage the reader to engage in it for their physical and mental well-being.

What many physicists get wrong about biology, is that physics is an approach to studying Nature, not Nature itself. The fact that a fundamental equation of biophysics cannot yet be written does not mean it will not be in the future, and if so it will surely rely on the solid physical framework existing today. 

Before continuing with less abstract, handwavy concepts, I want you to reflect on one last idea.

Ecosystems are made of living organisms interacting with each other; organisms are made up of cells; cells are made up of biomolecules; biomolecules are made up of atoms. We may give these fields names like biochemistry, molecular biology, cellular biology, animal or plant biology, ecology, but at the end of the day they all describe complex systems made up of parts interacting with each other in some way. One thing is certain: the way these parts interact is surely not random. And if physics aims at finding general rules that quantitatively predict the interactions between fundamental building blocks and emergent behaviour in complex systems, I cannot help but think it makes the perfect approach to study biology.